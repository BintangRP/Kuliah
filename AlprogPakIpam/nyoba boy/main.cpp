...
bool loginawal(){
	...
	pw = _getch();
        ...
        while(pw != 13){ //character 13 is enter
    ...
    cout<<endl;
        ...
        //percabangan untuk mengidentifikasi apakah username dan password yang diinput benar
...
int menu(){
    ...
    return pilih; //fungsi ini mengembalikan nilai var pilih
}
...
void lihatdata(){
    ...
    nomor--;
        ...
        if (nomor < temp){
            //perulangan menampila=kan catatan
...
void cari(){
    ...
    cout << "\n\n";
        ...
        while(i<temp){
            ...
            //jika judul catatan sama dengan judul yang dicari, tampilkan semua
...
////// PROSEDUR JIKA INPUTAN MENU BUKAN 1-4 //////
void error(){
        try
            {
                //throw(53);
